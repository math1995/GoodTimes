...
function bavotasan_widgets_init() {
	...
	register_sidebar( array(
		...
		'description' => __( 'Area on the home page above the main content. Designed specifically for three Icon & Text widgets. Add at least one widget to make it appear.', 'national' ),
